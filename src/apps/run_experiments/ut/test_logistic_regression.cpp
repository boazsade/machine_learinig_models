...
BOOST_AUTO_TEST_CASE(invalid_args_logistic_reg)
{
    const std::string invalid_args{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.log-reg\",\"attr\": {\"arg1\": 111,\"arg2\": 2343}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
...
BOOST_AUTO_TEST_CASE(wrong_logistic_reg_args_test)
{
    const std::string args4svm{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.log-reg\",\"attr\": {\"termination-count\": 111,\"termination-epsilon\": 2343}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
    try {
...
BOOST_AUTO_TEST_CASE(missing_logistic_reg_args)
{

    const std::string missing_args{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.log-reg\",\"attr\": {\"learning-rate\": 55.111,\"batch-type\": \"batch\", \"min-batch-size\": 55}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
...
BOOST_AUTO_TEST_CASE(valid_logistic_reg)
{
    const std::string msg{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.log-reg\",\"attr\": {\"learning-rate\": 55.111,\"batch-type\": \"batch\", \"reg-level\": \"reg_l1\",\"iterations\":234,\"min-batch-size\": 55}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
    try {
