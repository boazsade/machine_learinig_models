...
BOOST_AUTO_TEST_CASE(invalid_args_k_nearst)
{
    const std::string invalid_args{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.k_nearest\",\"attr\": {\"arg1\": 111,\"arg2\": 2343}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
...
BOOST_AUTO_TEST_CASE(wrong_k_nearst_args_test)
{
    const std::string args4svm{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.k_nearest\",\"attr\": {\"termination-count\": 111,\"termination-epsilon\": 2343}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
    try {
...
BOOST_AUTO_TEST_CASE(missing_k_nearst_args)
{

    const std::string missing_args{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.k_nearest\",\"attr\": {\"count\": 51}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
...
BOOST_AUTO_TEST_CASE(valid_k_nearst)
{
    const std::string msg{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.k_nearest\",\"attr\": {\"count\": 11,\"type\": \"brute-force\"}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
    try {
