...
BOOST_AUTO_TEST_CASE(invalid_args_rtrees)
{
    const std::string invalid_args{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.rtrees\",\"attr\": {\"arg1\": 111,\"arg2\": 2343}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
...
BOOST_AUTO_TEST_CASE(wrong_rtrees_args_test)
{
    const std::string args4svm{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.rtrees\",\"attr\": {\"termination-count\": 111,\"termination-epsilon\": 2343}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
    try {
...
BOOST_AUTO_TEST_CASE(missing_rtrees_args)
{

    const std::string missing_args{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.rtrees\",\"attr\": {\"regression-accuracy\": 111.55}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
...
BOOST_AUTO_TEST_CASE(valid_rtrees)
{
    const std::string msg{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/normalized.csv\"},\"model\": {\"class\": \"mycolumn\",\"type\": \"classifier\",\"repeations\": 43},\"actions\": [{\"action\": \"model.rtrees\",\"attr\": {\"var-importance\": true,\"type\": \"real\", \"regression-accuracy\": 1.1,\"max-categories\": 88,\"cv-fold\": 234,\"max-depth\":523,\"min-samples\":98,\"use-surrogates\":true,\"flags\": \"max\"}}],\"evaluation\": [\"auc-roc\",\"ks-test\"],\"validation\": {\"action\": \"k-fold\",\"attr\": {\"arg\": 10}}}"
    };
    try {
