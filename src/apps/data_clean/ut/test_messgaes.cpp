...
BOOST_AUTO_TEST_CASE( test_invalid_message )
{
    try {
        ...
        BOOST_TEST(false, "we expecting to get invalid json excaption, but got something else!!");
...
BOOST_AUTO_TEST_CASE( test_no_such_input_file_message )
{
    try {
        ...
        BOOST_TEST(false, "we expecting to get invalid json exception but we got something else");
    }
}
...
BOOST_AUTO_TEST_CASE( test_valid_message ) 
{
    ...
    const std::string json_str{
        "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/files\"},\"export\": {\"type\": \"csv\",\"path\": \"/path/to/existing/dirctory/to/which/to/export/file_name.csv\"},\"actions\": [{\"action\": \"filter.rows\",\"attr\": {\"colid\": \"age\",\"rows\": [1, 2, 3]}},{\"action\": \"fix.missing\",\"attr\": {\"colid\": \"marital\",\"algo\": \"cubical\",\"rows\": [7, 89, 65]}},{\"action\": \"normalized\",\"attr\": {\"colid\": \"StartTime\",\"algo\": \"min-max\",\"min\": 23.1,\"max\": 33.4}},{\"action\": \"normalized\",\"attr\": {\"colid\": \"age\",\"algo\": \"znorm\"}},{\"action\": \"normalized\",\"attr\": {\"colid\": \"matrial\",\"algo\": \"znorm\"}},{\"action\": \"fix.missing\",\"attr\": {\"colid\": \"status\",\"algo\": \"kneighborhood\",\"count\": 3,\"rows\": [11, 43, 675]}},{\"action\": \"fix.missing\",\"attr\": {\"colid\": \"data\",\"algo\": \"cubical\",\"rows\": [1893, 2343, 99975]}}]}"
    };
    try {
...
{
    const std::string json_str{
         "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/files\"},\"export\": {\"type\": \"csv\",\"path\": \"/path/to/existing/dirctory/to/which/to/export/file_name.csv\"},\"actions\": [{\"action\": \"filter.rows\",\"attr\": {\"colid\": \"age\",  \"rows\": [1, 2, 3]}},{\"action\": \"fix.missing\",\"attr\": {\"colid\": \"marital\",\"algo\": \"cubical\",\"rows\": [7, 89, 65]}}]}"
   };
    const filterout_conf::row_numbers expected_droped_rows{
        1, 2, 3
    };
    const cubical_fix::row_numbers expected_invalid_rows{
        7, 89, 65
    };
    ...
    try {
        ...
        const cubical_fix expected_missing_action{0, std::begin(expected_invalid_rows), std::end(expected_invalid_rows)};
        ...
        BOOST_TEST(false, "error while reading json input: "<<e.what());
    } catch (...) {
...
{
    const std::string json_str{
         "{\"dataset\": \"59705aa8aa39d855e5678b50\",\"datasource\": {\"path\": \"/home/foo/inputs/files\"},\"export\": {\"type\": \"csv\",\"path\": \"/path/to/existing/dirctory/to/which/to/export/file_name.csv\"},\"actions\": [{\"action\": \"filter.rows\",\"attr\": {\"colid\": \"filterout\",  \"rows\": [1, 2, 3]}},{\"action\": \"fix.missing\",\"attr\": {\"colid\": \"missing\",\"algo\": \"cubical\",\"rows\": [7, 89, 65]}},{\"action\": \"normalized\",\"attr\": {\"colid\": \"norm\",\"algo\": \"znorm\"}}]}"
   };
    const filterout_conf::row_numbers expected_droped_rows{
        1, 2, 3
    };
    ...
    try {
        ...
        const z_normaliztion_conf norm_action{0};
        ...
        BOOST_TEST(false, "this is a valid operation input, we should not have gotten an exception("<<e.what()<<")");
    }
}
